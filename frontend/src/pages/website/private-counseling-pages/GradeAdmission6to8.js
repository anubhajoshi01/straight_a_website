        ...
        return (
            ...
            <section>
                    <div className="img-text-container">
                        <img src="https://images.unsplash.com/photo-1620003048292-c4db88559488?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NzN8fHNjaG9vbHxlbnwwfDB8MHx8&auto=format&fit=crop&w=800&q=60"/>
                        <div className="center-txt">初中学校录取书</div>
                    </div>
            </section>
                ...
                <ul className="grade-adm-hl">
                    <li>
                        <div className='list-school'>
                            <h3>Horace Mann School</h3>
                            <p><br/></p>
                            <h3>Milton Academy</h3>
                            <p><br/></p>
                            <h3>Dwight-Englewood School</h3>
                        </div>
                    ...
                    <li>
                        <div className='list-school'> 
                            <h3>The Pingry School</h3>
                            <p><br/></p>
                            <h3>Polytechnic School</h3>
                            <p><br/></p>
