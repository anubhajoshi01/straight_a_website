   ...
   // console.log(lang)
        ...
        return (
            ...
            <div className="grade-admissions-container">
                ...
                <section>
                    <ul className="grade-adm-hl-1">
                        <li>
                            <img src="https://images.unsplash.com/photo-1571193161738-deaba9b6cc26?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTh8fHN0dWRlbnR8ZW58MHwxfDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60"/>
                        </li>
                        <li>
                            <div>
            ...
            <div className="grade-admissions-container">
                <section>
                    ...
                    <div className="left-img-adm">
                        <img src="https://images.unsplash.com/photo-1617713430783-eea916372c5b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjF8fHN0dWRlbnR8ZW58MHwxfDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60"/>
                    </div>
                </section>
                <div className="grade-adm-margin">
                <section>
            ...
            <section>
                    <div className="img-text-container">
                        <img src="https://images.unsplash.com/photo-1617365227965-93f9b17832e1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzF8fGNvbGxlZ2UlMjBidWlsZGluZ3xlbnwwfDB8MHx8&auto=format&fit=crop&w=800&q=60"/>
                        <div className="center-txt">大学录取书</div>
                    </div>
            </section>
    ...
    return (
        ...
        <section>
                <div className="img-text-container">
                    <img src="https://images.unsplash.com/photo-1617365227965-93f9b17832e1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzF8fGNvbGxlZ2UlMjBidWlsZGluZ3xlbnwwfDB8MHx8&auto=format&fit=crop&w=800&q=60"/>
                    <div className="center-txt">College Offers We Received in Past 3 Years</div>
                </div>
        </section>
        <div className="offers-list">
            <ul className="grade-adm-hl">
...
export default GradeAdmission6to8